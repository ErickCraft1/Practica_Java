 ...
 * "Pattern Matching uses two loops: the outer loop tests each valid starting position in
 * num — valid means that the complete pattern still fits — and the inner loop compares
 * element by element until a full match is confirmed or it is discarded."
